...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image12": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/image_of_person.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image41": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/6077dce7ec07854a8c820c4e_image_processing20200129-19798-1k8ponz%204-min-p-500.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image52": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/left-right-arrow-button.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox87": {
      "custom": {
        "text": "MSc (Human Computer Interactioin)"
      },
      "callbacks": {
        "onClick": [
          {
